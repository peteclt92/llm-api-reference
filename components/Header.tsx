...
export function Header() {
    ...
    return (
        <header className={`bg-white/70 dark:bg-zinc-950/70 backdrop-blur-md sticky top-0 z-50 transition-all duration-[350ms] ${showBorder ? 'border-b border-zinc-200 dark:border-zinc-900' : ''}`}>
